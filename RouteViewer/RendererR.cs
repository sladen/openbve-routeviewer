...
namespace OpenBve {
    internal static class Renderer {
        ...
        internal static void Initialize() {
            ...
            // textures
            string Folder = Interface.GetCombinedFolderName(Interface.GetDataFolder(), "RouteViewer");
            BackgroundChangeTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "background.png"), TextureManager.TextureWrapMode.ClampToEdge, true);
            BrightnessChangeTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "brightness.png"), TextureManager.TextureWrapMode.ClampToEdge, true);
            TransponderTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "transponder.png"), TextureManager.TextureWrapMode.ClampToEdge, true);
            SectionTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "section.png"), TextureManager.TextureWrapMode.ClampToEdge, true);
            LimitTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "limit.png"), TextureManager.TextureWrapMode.ClampToEdge, true);
            StationStartTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "station_start.png"), TextureManager.TextureWrapMode.ClampToEdge, true);
            StationEndTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "station_end.png"), TextureManager.TextureWrapMode.ClampToEdge, true);
            StopTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "stop.png"), TextureManager.TextureWrapMode.ClampToEdge, true);
            BufferTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "buffer.png"), TextureManager.TextureWrapMode.ClampToEdge, true);
            SoundTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "sound.png"), TextureManager.TextureWrapMode.ClampToEdge, true);
        ...
        private static void RenderOverlays(double TimeElapsed) {
            ...
            if (Program.CurrentlyLoading) {
                ...
                if (ObjectManager.ObjectsUsed == 0) {
                    ...
                    Keys = new string[][] { new string[] { "F1" }, new string[] { "F2" }, new string[] { "F3" }, new string[] { "F4" }, new string[] { "F12" } };
                    RenderKeys((double)ScreenWidth - 36.0, 4.0, 32.0, Keys);
                    RenderString((double)ScreenWidth - 44.0, 4.0, Fonts.FontType.Small, "Wireframe: " + (Renderer.OptionWireframe ? "on" : "off"), 1, 1.0f, 1.0f, 1.0f, true);
                    RenderString((double)ScreenWidth - 44.0, 24.0, Fonts.FontType.Small, "Normals: " + (Renderer.OptionNormals ? "on" : "off"), 1, 1.0f, 1.0f, 1.0f, true);
                    RenderString((double)ScreenWidth - 44.0, 44.0, Fonts.FontType.Small, "Events: " + (Renderer.OptionEvents ? "on" : "off"), 1, 1.0f, 1.0f, 1.0f, true);
                    RenderString((double)ScreenWidth - 44.0, 64.0, Fonts.FontType.Small, "Hide interface", 1, 1.0f, 1.0f, 1.0f, true);
                    RenderString((double)ScreenWidth - 44.0, 84.0, Fonts.FontType.Small, "CPU: " + (Program.CpuAutomaticMode ? "auto " + (Program.CpuReducedMode ? "(low)" : "(high)") : "high"), 1, 1.0f, 1.0f, 1.0f, true);
                    ...
                    /// info
                    double x = 0.5 * (double)ScreenWidth - 128.0;
                    RenderString(x, 4.0, Fonts.FontType.Small, "Position: " + World.CameraCurrentAlignment.TrackPosition.ToString("0.00", Culture) + " (X=" + World.CameraCurrentAlignment.TrackOffset.X.ToString("0.00", Culture) + " Y=" + World.CameraCurrentAlignment.TrackOffset.Y.ToString("0.00", Culture) + ")", -1, 1.0f, 1.0f, 1.0f, true);
                    if (Program.CurrentStation >= 0) {
                        ...
                        RenderString(x, 20.0, Fonts.FontType.Small, t.ToString(), -1, 1.0f, 1.0f, 1.0f, true);
                    }
                    if (Interface.MessageCount == 1) {
                        Keys = new string[][] { new string[] { "F9" } };
                        RenderKeys(4.0, 52.0, 24.0, Keys);
                        RenderString(32.0, 52.0, Fonts.FontType.Small, "Display the 1 error recently generated.", -1, 1.0f, 0.5f, 0.5f, true);
                    } else if (Interface.MessageCount > 1) {
                        Keys = new string[][] { new string[] { "F9" } };
                        RenderKeys(4.0, 52.0, 24.0, Keys);
                        RenderString(32.0, 52.0, Fonts.FontType.Small, "Display the " + Interface.MessageCount.ToString(Culture) + " errors recently generated.", -1, 1.0f, 0.5f, 0.5f, true);
                    }
                }
            }
            // finalize
