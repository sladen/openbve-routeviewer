            ...
            if (video != IntPtr.Zero) {
                ...
                while (!Quit) {
                    ...
                    if (CpuReducedMode) {
                        ...
                        if (World.CameraAlignmentDirection.TrackOffset.X != 0.0 | World.CameraAlignmentDirection.TrackOffset.Y != 0.0 | World.CameraAlignmentDirection.TrackOffset.Z != 0.0 | World.CameraAlignmentDirection.Pitch != 0.0 | World.CameraAlignmentDirection.Yaw != 0.0 | World.CameraAlignmentDirection.Roll != 0.0 | World.CameraAlignmentDirection.TrackPosition != 0.0 | World.CameraAlignmentDirection.Zoom != 0.0) {
                            ReducedModeEnteringTime = a + 2500;
                ...
                switch (Event.type) {
                    ...
                    case Sdl.SDL_KEYDOWN:
                        switch (Event.key.keysym.sym) {
                            ...
                            case Sdl.SDLK_a:
                            case Sdl.SDLK_KP4:
                                World.CameraAlignmentDirection.TrackOffset.X = -World.CameraExteriorTopSpeed;
                            ...
                            case Sdl.SDLK_KP6:
                                ...
                                break;
                            case Sdl.SDLK_KP2:
                                World.CameraAlignmentDirection.TrackOffset.Y = -World.CameraExteriorTopSpeed;
                                CpuReducedMode = false;
                                break;
                            case Sdl.SDLK_KP8:
                                World.CameraAlignmentDirection.TrackOffset.Y = World.CameraExteriorTopSpeed;
                    ...
                    case Sdl.SDL_KEYUP:
                        switch (Event.key.keysym.sym) {
                            ...
                            case Sdl.SDLK_d:
                            case Sdl.SDLK_KP6:
                                World.CameraAlignmentDirection.TrackOffset.X = 0.0;
                                break;
                            case Sdl.SDLK_KP2:
                            case Sdl.SDLK_KP8:
                                World.CameraAlignmentDirection.TrackOffset.Y = 0.0;
                                break;
                            case Sdl.SDLK_w:
                            case Sdl.SDLK_KP9:
                            case Sdl.SDLK_s:
