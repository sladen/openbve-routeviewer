...
namespace OpenBve {
	internal static class Renderer {
		...
		internal static void Initialize() {
			...
			BackgroundChangeTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "background.png"), TextureManager.TextureWrapMode.ClampToEdge, TextureManager.TextureWrapMode.ClampToEdge, true);
			BrightnessChangeTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "brightness.png"), TextureManager.TextureWrapMode.ClampToEdge, TextureManager.TextureWrapMode.ClampToEdge, true);
			TransponderTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "transponder.png"), TextureManager.TextureWrapMode.ClampToEdge, TextureManager.TextureWrapMode.ClampToEdge, true);
			SectionTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "section.png"), TextureManager.TextureWrapMode.ClampToEdge, TextureManager.TextureWrapMode.ClampToEdge, true);
			LimitTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "limit.png"), TextureManager.TextureWrapMode.ClampToEdge, TextureManager.TextureWrapMode.ClampToEdge, true);
			StationStartTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "station_start.png"), TextureManager.TextureWrapMode.ClampToEdge, TextureManager.TextureWrapMode.ClampToEdge, true);
			StationEndTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "station_end.png"), TextureManager.TextureWrapMode.ClampToEdge, TextureManager.TextureWrapMode.ClampToEdge, true);
			StopTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "stop.png"), TextureManager.TextureWrapMode.ClampToEdge, TextureManager.TextureWrapMode.ClampToEdge, true);
			BufferTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "buffer.png"), TextureManager.TextureWrapMode.ClampToEdge, TextureManager.TextureWrapMode.ClampToEdge, true);
			SoundTexture = TextureManager.RegisterTexture(Interface.GetCombinedFileName(Folder, "sound.png"), TextureManager.TextureWrapMode.ClampToEdge, TextureManager.TextureWrapMode.ClampToEdge, true);
